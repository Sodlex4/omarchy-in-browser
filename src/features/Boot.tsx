    ...
    >
      ...
      <div className="relative max-w-2xl w-full px-8">
        <div className="mb-8 flex items-center gap-3">
          ...
          <span className="text-xs uppercase tracking-[0.3em] text-muted-foreground">myomarchy boot</span>
        </div>
        <pre className="text-sm leading-relaxed text-foreground/90">
          {shown.map((l, i) => {
            ...
            return (
              <div key={i} className={isWelcome ? "text-neon-green text-glow-green text-xl mt-4" : isPrompt ? "text-neon-purple text-glow-purple animate-pulse" : ""}>
